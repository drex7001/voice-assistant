...
def vision_prompt(prompt,photo_path):
    ...
    prompt = (
        ...
        'to send to another AI that create a response to the user. Do not respond as the AI assistant '
...
def start_listening():
    ...
    print('\nSay ', wake_word, 'followed with your question: ')
